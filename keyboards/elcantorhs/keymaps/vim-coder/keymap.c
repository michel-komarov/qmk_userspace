...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_ESC,         KC_1,          LCTL_T(KC_2), LALT_T(KC_3), LSFT_T(KC_4), KC_5,    /* | */    KC_6,         RSFT_T(KC_7), RALT_T(KC_8), RCTL_T(KC_9), KC_0,         KC_QUOT,
        KC_TAB,         KC_NO,         KC_NO,        MO(4),        KC_NO,        KC_NO,   /* | */    KC_NO,        KC_NO,        KC_COMM,      KC_DOT,       KC_SLSH,      KC_BSLS,
                                       KC_NO,        KC_NO,        KC_TRNS,      KC_NO,   /* | */    KC_SPC,       MO(3),        KC_ENT,       KC_MINS
    ),
    [2] = LAYOUT(
        KC_NO,          KC_NO,         KC_NO,        KC_NO,        KC_NO,        KC_PSCR, /* | */    KC_HOME,      KC_HOME,      KC_PGUP,      KC_WH_U,      KC_NO,        KC_INS,
        KC_ESC,         KC_NO,         KC_LCTL,      KC_LALT,      KC_LSFT,      KC_NO,   /* | */    KC_LEFT,      KC_DOWN,      KC_UP,        KC_RGHT,      KC_NO,        KC_DEL,
        KC_TAB,         KC_NO,         KC_NO,        KC_WH_L,      KC_WH_R,      KC_NO,   /* | */    KC_END,       KC_END,       KC_PGDN,      KC_WH_D,      KC_NO,        KC_NO,
    ...
    [4] = LAYOUT(
        KC_NO,          KC_NO,         KC_NO,        KC_NO,        KC_NO,        KC_NO  , /* | */    KC_HOME,      KC_LPRN,      KC_RPRN,      KC_UP,        KC_NO,        KC_EQL,
        KC_ESC          KC_NO,         KC_LCTL,      KC_NO,        KC_LSFT,      KC_NO  , /* | */    KC_LEFT,      KC_LCBR,      KC_RCBR,      KC_RGHT,      KC_SCLN,      KC_QUOT,
        KC_TAB,         KC_NO,         KC_NO,        KC_TRNS,      KC_NO,        KC_NO  , /* | */    KC_END,       KC_LBRC,      KC_RBRC,      KC_DOWN,      KC_SLSH,      KC_BSLS,
                                       KC_NO,        KC_NO,        KC_TRNS,      KC_NO,   /* | */    KC_SPC,       KC_NO,        KC_ENT,       KC_MINS
    )
};
