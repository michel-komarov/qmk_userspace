...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        KC_NO,          KC_NO,         KC_NO,        KC_NO,        KC_NO,        KC_PSCR, /* | */    KC_NO,        KC_HOME,      KC_PGUP,      KC_WH_U,      KC_NO,        KC_INS,
        KC_ESC,         KC_NO,         KC_LCTL,      KC_LALT,      KC_LSFT,      KC_NO,   /* | */    KC_LEFT,      KC_DOWN,      KC_UP,        KC_RGHT,      KC_NO,        KC_DEL,
        KC_TAB,         KC_NO,         KC_NO,        KC_WH_L,      KC_WH_R,      KC_NO,   /* | */    KC_NO,        KC_END,       KC_PGDN,      KC_WH_D,      KC_NO,        KC_NO,
    ...
    [3] = LAYOUT(
        ...
        KC_TAB,         KC_NO,         KC_NO,        KC_NO,        KC_NO,        KC_NO,   /* | */    KC_NO,        KC_NO,        KC_NO,        KC_NO,        KC_NO,        KC_NO,
                                       QK_BOOT,      KC_NO,        KC_TRNS,      KC_NO,   /* | */    KC_NO,        KC_TRNS,      KC_NO,        ANY(QK_RBT)
    )
};
